				...
				<div class="pagebody3_news" id="xiaoxi" style="height:500px;">
					...
					<ul>
						<c:forEach var="publicmessage" items="${page.list}"
							varStatus="status">
							<li onclick="detail('${publicmessage.url}')">
								<a href="javascript:;">${publicmessage.title}</a>
								<span>
								<fmt:formatDate
                 ...
                 <!-- 
                  ...
                  -->
					<ul class="page">
					    ...
					    <a href="${ctx}/index/news?pageNum=${pageNo}"
						   style="background: #C30D23 none repeat scroll 0% 0%;color:#ffffff;">${pageNo}</a>
					     </c:when>
					   <c:otherwise>
